 ...
 * @returns {undefined}
 */
function setOptions(nmOptions) {
  options['nodemailer'] = nmOptions['nodemailer'];
}
 ...
 * @returns {undefined}
 */
function ServiceNodemailer(nmOptions, setLocalOptions) {
  if(setLocalOptions) {
    setOptions(nmOptions);
  }
...
module.exports = ServiceNodemailer;